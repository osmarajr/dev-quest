...
*/
let escolhaHospedagem = confirm('Gostaria de pagar R$ 50,00 para passar a noite na nossa hospedagem?')

// if (escolhaHospedagem){
//     alert('Ótimo! Nós temos as melhores camas de toda a região!')
// }else{
//     alert('Que pena! Você parecia ser uma pessoa mais legal')
// }

escolhaHospedagem ? alert('Ótimo! Nós temos as melhores camas de toda a região!') : alert('Que pena! Você parecia ser uma pessoa mais legal')